...
class example1_hidden_elements_page:
    ...
    def __wait_for_hidden_text(self):
        ...
        web_driver_wait.until(EC.visibility_of_element_located(self.__hidden_text))

    def verify_default_content(self):
        assert self.__headers_page_text() == "Dynamically Loaded Page Elements"
        assert self.__body_text() == "Example 1: Element on page that is hidden"
